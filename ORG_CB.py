...
def write_fancy_table_to_csv(ins, n, m, c, val, s_cons, h_cons, peak, status, time_elapsed, filename="SAML3P.csv"):
    global best_result
...
if os.path.exists("SAML3P_time.py.txt"):
    with open("SAML3P_time.py.txt", "r") as f:
...
if __name__ == "__main__":
    ...
    if len(sys.argv) > 1 and sys.argv[1] in ['-h', '--help', 'help']:
        print("Usage:")
        print("  python3 SAML3P_time.py              # Run all instances with runlim")
        print("  python3 SAML3P_time.py <id>         # Run single instance by ID")
        print("  python3 SAML3P_time.py easy         # Run only easy instances (0-38)")
        print("  python3 SAML3P_time.py hard         # Run only hard instances (39+)")
        print("  python3 SAML3P_time.py all          # Run all instances")
        print("")
        ...
        print("")
        print("Optional timeout file: SAML3P_time.py.txt")
    ...
    if len(sys.argv) == 1:
        ...
        for instance_id in range(0, len(file_name1)):
            ...
            command = f"./runlim -r {TIMEOUT} python3 SAML3P_time.py {instance_id}"
